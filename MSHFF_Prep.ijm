...
if (usedialog==0) {
	...
	root	="/Users/omaralamoudi/Dropbox/GraduateSchool/PhD/Projects/Fracture Detection and Property Measurements/using Voorn-2013/runs/comparing 0_degree and 18_degree/0_degree/root/";
	doroifile	=1;
	dolinesfile	=1;
	ming		=1;
	maxg		=9; // I want this to be 12
	stepg		=2; // I want this to be 1
} else {
	...
	Dialog.addString("Path to root folder. Use '"+File.separator+"' for subfolders and at end!", "D:\\Rootfolder\\",50);
...
if (doroifile==true) {
	...
	if (seltype==0) {
		print("makeRectangle(",xroi,",",yroi,",",widthroi,",",heightroi,")"); // open a Log window and print this line
	} else if (seltype==1) {
